...
<body>
	 ...
	 <%
	if (request.getParameter("reportModuleID") != null) {
		response.sendRedirect(
		"/AttendanceDAO/ReportsServlet?action=showAllStudents&reportModuleID=" + request.getParameter("reportModuleID"));
	}
	%>
	...
	List<Module> reportModuleList = (List<Module>) session.getAttribute("reportModuleList");
	%>
	...
	<div class="grid-container">
		<div class="main-container">
			...
			<form id="moduleForm" action="selectModule.jsp" method="GET">
				<div class="module-container">
					<c:forEach items="${reportModuleList}" var="module">
				...
				<input type="hidden" id="reportModuleID" name="reportModuleID">
				<br />
	...
	<script>
		...
		function selectModule(moduleId) {
			...
			document.getElementById('module-' + moduleId).classList
					.add('selected');
			document.getElementById('reportModuleID').value = selectedModuleId; // Update the hidden input whenever a module is selected
		}
